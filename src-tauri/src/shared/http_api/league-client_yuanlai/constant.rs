...
pub mod api {
    pub static ITEM_URI: &str = "lol-game-data/assets/v1/items.json"; // 物品
    pub static CHAMPION_URI: &str = "lol-game-data/assets/v1/champion-summary.json"; // 英雄
    pub static SPELL_URI: &str = "lol-game-data/assets/v1/summoner-spells.json"; // 召唤师技能
    pub static PERK_URI: &str = "lol-game-data/assets/v1/perkstyles.json"; // 符文
}
...
pub static CHAMPION_MAP: phf::Map<u16, ChampionOption> = phf_map! {
    ...
    39u16 => ChampionOption { label: "刀锋舞者", value: 39, real_name: "艾瑞莉娅", nickname: "刀妹" },
